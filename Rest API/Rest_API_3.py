...
page = requests.get("https://google.com/search", params=d) # only set type params allowred

# browse link : https://www.google.com/search?q=%22violins+and+guitars%22&tbm=isch
