...
## Removal of an Item
# Removes 5 fromt set b but b.remove(15) # throws an error while trying to remove 15 (which is not present in the set)
e.remove(5) 
...
##   creat set 20(int) 20.0(float) and 20(string) and print it with length
